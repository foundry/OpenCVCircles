...
@property (assign) CGFloat dp;
@property (assign) CGFloat minDist;
@property (assign) CGFloat param2;
@property (assign) int minRadius;
@property (assign) int maxRadius;
...
@property (weak, nonatomic) IBOutlet UISlider *minRadiusSlider;
@property (weak, nonatomic) IBOutlet UILabel *minRadiusLabel;
- (IBAction)minRadiusChanged:(id)sender;
- (IBAction)minRadiusTouchDragInside:(id)sender;

@property (weak, nonatomic) IBOutlet UISlider *maxRadiusSlider;
@property (weak, nonatomic) IBOutlet UILabel *maxRadiusLabel;
- (IBAction)maxRadiusChanged:(id)sender;
